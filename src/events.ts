 ...
 *   bridge:start    — chat bridge started processing a message
 *   bridge:complete — chat bridge finished processing
 *   bridge:enqueue  — message queued for processing
 *
 * Events listened to:
...
export function registerBridgeEvents(pi: ExtensionAPI, registry: ChannelRegistry): void {
	...
	// Backwards compatibility: also listen to channel:send
